...
public class Maidenhead_Register {
	
	WebDriver driver_Register_from_Maidenhead_first_use_notice;

	@Given("I am not a user of agate on maidenhead and I open a browser")
	@Test(priority=0)
	@Parameters("browser")
	public void i_am_not_a_user_of_agate_on_maidenhead_and_I_open_a_browser(String browser) {
		if(browser.equalsIgnoreCase("firefox")) {
			driver_Register_from_Maidenhead_first_use_notice = new FirefoxDriver();
			
		}else if (browser.equalsIgnoreCase("safari")) { 
			driver_Register_from_Maidenhead_first_use_notice= new SafariDriver();
			driver_Register_from_Maidenhead_first_use_notice.manage().window().maximize();
		} 
		else if (browser.equalsIgnoreCase("chrome")) { 
			driver_Register_from_Maidenhead_first_use_notice= new ChromeDriver();
		}   
	}

	@Given("I navigate to a premium article on maidenhead")
	@Test(priority=1)
	public void i_navigate_to_a_premium_article_on_maidenhead() throws InterruptedException {
		driver_Register_from_Maidenhead_first_use_notice.get("https://www.maidenhead-advertiser.co.uk/news/remember-when/143583/remember-when-tinker-model-railers-rowers-and-trail-blazers-at-lego-world.html");
		Thread.sleep(10000);
		String popbitch_navigation= driver_Register_from_Maidenhead_first_use_notice.getCurrentUrl();
	    try
		{
	    	AssertJUnit.assertTrue(popbitch_navigation.contains("https://www.maidenhead-advertiser.co.uk/news/remember-when/143583/remember-when-tinker-model-railers-rowers-and-trail-blazers-at-lego-world.html"));
	...
	@Test(priority=2)
	public void i_click_on_the_create_wallet_button_on_maidenhead() throws IOException, InterruptedException {
		Thread.sleep(3000);
		//Scroll by 200px
				JavascriptExecutor js = (JavascriptExecutor)driver_Register_from_Maidenhead_first_use_notice;
	...
	@Given("I verify that the create wallet button takes me to the reg page on maidenhead")
	@Test(priority=3)
	public void i_verify_that_the_create_wallet_button_takes_me_to_the_reg_page_on_maidenhead() throws InterruptedException {
		Register_Page_Elements reg_page = new Register_Page_Elements(driver_Register_from_Maidenhead_first_use_notice);
		 reg_page.wait_untill_page_has_loaded();
	}

	@When("I enter all the details successfully on reg page")
	@Test(priority=4)
	public void i_enter_all_the_details_successfully_on_reg_page() throws IOException, InterruptedException {
	...
	//String screenshot_name_2= "Popbitch_FUN_to_Register_1";
		File scrFile1 = ((TakesScreenshot)driver_Register_from_Maidenhead_first_use_notice).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrFile1, new File("/Users/jay/Desktop/Maidenhead/"+"_"+timestamp_2+"_"+"jpg" ));
Register_Page_Elements Register_elements = new Register_Page_Elements(driver_Register_from_Maidenhead_first_use_notice);
	...
	@Test(priority=5)
	public void i_am_registered_as_an_agate_user_on_maidenhead_successfully_and_I_am_shown_a_first_use_notice() throws IOException, InterruptedException {
		Thread.sleep(20000);
	    
	    
	    String Register_Elements_Expected_url= "https://www.maidenhead-advertiser.co.uk/news/remember-when/143583/remember-when-tinker-model-railers-rowers-and-trail-blazers-at-lego-world.html";
	    String Register_Elements_Actual_Url= driver_Register_from_Maidenhead_first_use_notice.getCurrentUrl();
		...
		//Verify that the finish notice appears
			Popbitch_Finish_Notice_elements pop_finish = new Popbitch_Finish_Notice_elements(driver_Register_from_Maidenhead_first_use_notice);
		...
		//Click off on finish notice and click on ok 
			...
			String timestamp_2 = new SimpleDateFormat("yyyy_MM_dd_HH_mm_ss").format(Calendar.getInstance().getTime());
			File scrFile_2 = ((TakesScreenshot)driver_Register_from_Maidenhead_first_use_notice).getScreenshotAs(OutputType.FILE);		
		...
		//Click on the green tab and 
			PopbitchFirstUseNoticeElements pop_first_use_top_up_from_wallet2 = new PopbitchFirstUseNoticeElements(driver_Register_from_Maidenhead_first_use_notice);
		...
		//get the balance after before first transaction. since we topped up with £2 the balance should be £2
			Thread.sleep(2000);
			Popbitch_Wallet_Elements_staging wallet_elements_1 = new Popbitch_Wallet_Elements_staging(driver_Register_from_Maidenhead_first_use_notice); 
		...
		//verify whether the expected balance is the actual balance
			...
			Thread.sleep(3000);
			Authorise_charge_notice_popbitch authy_popbitch = new Authorise_charge_notice_popbitch(driver_Register_from_Maidenhead_first_use_notice);
		...
		//Screen shot of article 1
			...
			File scrFile_3 = ((TakesScreenshot)driver_Register_from_Maidenhead_first_use_notice).getScreenshotAs(OutputType.FILE);		
		...
		//Screen shot of article 2
			...
			File scrFile_4 = ((TakesScreenshot)driver_Register_from_Maidenhead_first_use_notice).getScreenshotAs(OutputType.FILE);		
			FileUtils.copyFile(scrFile_4, new File("/Users/jay/Desktop/maidenhead/"+"_"+timestamp_4+"_"+"jpg" ));
			JavascriptExecutor js1 = (JavascriptExecutor)driver_Register_from_Maidenhead_first_use_notice;
		...
		//Screen shot of article 3		
			...
			File scrFile_5 = ((TakesScreenshot)driver_Register_from_Maidenhead_first_use_notice).getScreenshotAs(OutputType.FILE);		
			FileUtils.copyFile(scrFile_5, new File("/Users/jay/Desktop/maidenhead/"+"_"+timestamp_5+"_"+"jpg" ));
